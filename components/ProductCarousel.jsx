  ...
  return (
    <div className="relative ">
      <div className="flex justify-center items-center ">
        <Button className="absolute top-1/2 left-0 transform -translate-y-1/2 bg-[#2F3031] text-2xl mx-2 text-white p-2 rounded-full focus:outline-none z-10" onClick={handlePrev}>
          &lt;
        </Button>
                  ...
                  <div className="max-w-full min-w-80 mx-auto rounded-xl my-1 hover:scale-105 text-black bg-[#2F3031] transition hover:cursor-pointer">
                    <div className="flex flex-col">
                      ...
                      <div className="flex flex-col justify-between p-4">
                        <p className="text-md mb-4 mt-2 font-semibold text-white">{product.title}</p>
        ...
        <Button className="absolute top-1/2 right-0 transform -translate-y-1/2 bg-[#2F3031] text-2xl  mx-2 text-white p-2 rounded-full  z-10" onClick={handleNext}>
          &gt;
        </Button>
      </div>
    </div>
